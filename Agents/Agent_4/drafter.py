...
# injector state - way to pass state to tools

# global variable - alternative for injector state
document_content = ""
...
def save(filename:str) -> str:
    """Saves the current document content to a file and finish the process
...
def our_agent(state: AgentState)-> AgentState:
    """This is the agent node of our graph"""
...
def should_continue(state: AgentState)-> AgentState:
    ...
    for message in reversed(messages):
        # check if the tool message is resulting in save....
...
def print_messages(messages):
    """Function to make the output readable"""
    if not messages:
        return
